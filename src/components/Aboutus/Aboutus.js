...
import Images from "./../images/dd_logo.jpg";
...
const Aboutus = () => {
  return (
    ...
    <Link className="btn btn-light mx-1" to="/Home" role="button">
      ...
      <h3 className="about">
        Welcome To <span id="W_Name1">Daily Delight</span>
      </h3>
      <div className="content">
      <p><b>
        <span id="W_Name2">Daily Delight</span> is a Professional{" "}
      ...
      <div className="hero-logo">
                  <img src={Images} alt="Daily Delight Loading..."/>
              </div>
